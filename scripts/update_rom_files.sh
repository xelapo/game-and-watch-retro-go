...
find ${@:2} -type f \( -iname \*.gb -o -iname \*.gbc -o -iname \*.nes -o -iname \*.gw -o -iname \*.sms -o -iname \*.gg -o -iname \*.sg -o -iname \*.md -o -iname \*.gen -o -iname \*.bin -o -iname \*.col -o -iname \*.pce -o -iname \*.rom -o -iname \*.dsk -o -iname \*.mx1 -o -iname \*.mx2 -o -iname \*.png -o -iname \*.jpg -o -iname \*.bmp \) | sort > "${TMPFILE}" 2> /dev/null
